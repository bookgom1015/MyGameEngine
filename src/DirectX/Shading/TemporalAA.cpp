...
BOOL TemporalAAClass::Initialize(Locker<ID3D12Device5>* const device, ShaderManager* const manager, UINT width, UINT height) {
	md3dDevice = device;
...
BOOL TemporalAAClass::BuildDescriptors() {
...

	{
		...
		device->CreateShaderResourceView(mHistoryMap->Resource(), &srvDesc, mhHistoryMapCpuSrv);
	}
